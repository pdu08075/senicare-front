            ...
            <div className="auth-container">
                <div style={{ gap: '16px' }} className="auth-box">
                    ...
                    <div className="input-container">
                        ...
                        <InputBox value={telNumber} label='전화번호' type='text'placeholder='-빼고 입력해주세요.' buttonName='전화번호 인증' onChange={onTelNumberChangeHandler} onButtonClick={onTelNumberSandClickHandler} />
                        <InputBox value={authNumber} label='인증번호' type='text'placeholder='인증번호 4자리를 입력해주세요.' buttonName='인증 확인' onChange={onAuthNumberChangeHandler} onButtonClick={onAuthNumberSandClickHandler} />
                    </div>

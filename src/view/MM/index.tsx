...
import Paginaion from 'src/components/pagination';
    ...
    return (
        <div className='post-patch-box'>
            <div className='post-patch-input-container'>
                ...
                <div className='input-box' style={{ flex: 1 }}>
                    <div className='input-label'>용도</div>
                    <input className='input' placeholder='용도를 입력해주세요' onChange={onPurposeChangeHandler} />
                </div>
                <div className='input-box'>
                    <div className='input-label'>개수</div>
                    <input className='input' placeholder='개수를 입력해주세요' onChange={onCountChangeHandler} />
                </div>
            </div>
